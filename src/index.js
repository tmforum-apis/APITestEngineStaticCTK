...
if (cmdArgs == null) {
  ...
  CliController.performCLIComplianceCheck(cmdArgs['compare'][0], cmdArgs['compare'][1]).catch(error => {
  ...
  CliController.performCLIComplianceCheckWithAPI(cmdArgs['compareAPIKey'][0], cmdArgs['compareAPIKey'][1], cmdArgs['compareAPIKey'][2]).catch(error => {
