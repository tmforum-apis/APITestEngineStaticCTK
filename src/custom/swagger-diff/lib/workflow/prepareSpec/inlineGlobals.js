...
function inlineGlobals (spec) {
  var paths = (0, _lodash2.default)(spec[_constants.PATHS_KEY], function (path) {
    var operations = (0, _lodash2.default)((0, _lodash6.default)(path, _constants.OPERATION_KEYS), function (
      operation
    ) {
      return _extends(
        {},
        operation,
        (0, _lodash8.default)(
          _constants.GLOBAL_KEYS,
          _constants.GLOBAL_KEYS.map(function (key) {
  ...
  return _extends(
    {},
    (0, _lodash4.default)(spec, _constants.GLOBAL_KEYS),
    _defineProperty({}, _constants.PATHS_KEY, paths)
  );
}
